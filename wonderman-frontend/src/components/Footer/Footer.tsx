...
const Footer = () => {
    return (
        <div className="footer col-12 padding-3">
            <div className="row">
                <div className="col-6">
                    <div className="col-3 text-align-right">
                        <div className="font-size-2 margin-bottom-2 margin-right-1"><FontAwesomeIcon icon={faMap}/>
                        </div>
                        <div className="font-size-2 margin-bottom-2 margin-right-1"><FontAwesomeIcon icon={faPhone}/>
                        </div>
                ...
                <div className="col-6 text-align-right padding-bottom-1 padding-left-1 padding-right-1  font-size-1">
                    <h1 className="margin-top-0">Wonderman Store</h1>
                    <p>
                        Our online store offers a wide range of products to cater to every need and preference. Discover
                        a diverse selection of high-quality items, from the latest fashion trends to cutting-edge
                        electronics. Browse through our user-friendly interface, explore various categories, and find
